...
opts = {
  ...
  // Moderate fireworks timing
  fireworkSpawnTime: 300,          // Adjusted from 200
  fireworkBaseReachTime: 45,       // Adjusted from 30
  fireworkAddedReachTime: 45,      // Adjusted from 30
  fireworkCircleBaseTime: 45,      // Adjusted from 30
  fireworkCircleAddedTime: 45,     // Adjusted from 30
  fireworkCircleFadeBaseTime: 15,  // Adjusted from 10
  fireworkCircleFadeAddedTime: 8,  // Adjusted from 5

  fireworkBaseShards: 5,
  fireworkAddedShards: 5,
  fireworkShardPrevPoints: 3,

  // Moderate shard velocity
  fireworkShardBaseVel: 3,         // Between fast (4) and slow (2)
  fireworkShardAddedVel: 1.5,      // Between fast (2) and slow (1)
  fireworkShardBaseSize: 3,
  fireworkShardAddedSize: 3,

  gravity: 0.08,                   // Balanced gravity
  upFlow: -0.08,                   // Balanced upward flow for balloons

  // Moderate letter delay
  letterContemplatingWaitTime: 500, // Between fast (360) and slow (720)

  // Moderate balloon spawn and inflation
  balloonSpawnTime: 30,            // Between fast (20) and slow (40)
  balloonBaseInflateTime: 15,      // Between fast (10) and slow (20)
  balloonAddedInflateTime: 15,     // Between fast (10) and slow (20)

  balloonBaseSize: 20,
  balloonAddedSize: 20,
  balloonBaseVel: 0.3,             // Moderate balloon speed
  balloonAddedVel: 0.3,
